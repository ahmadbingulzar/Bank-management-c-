...
{
    string first_name, middle_name,last_name ,city, month, date, year, mobile, cnic_old,country;
    int account_number;
    fstream bank_data;
...
{
    string first_name, middle_name,last_name ,city, month, date, year, mobile, cnic_old,cnic;
    int account_number;
